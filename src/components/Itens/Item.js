...
export default function Item(props) {
  ...
  return (
    <article className="custom-list-item">
      <Link to={'/materiais/' + item.material.id} className="link has-text-dark">
        <div className="title is-6">{item.material.descricao}</div>
      </Link>
      <div className="subtitle is-7 mb-0">{item.fornecedor.nome} ({item.fornecedor.uf})</div>
